...
& Low & High & Male & Female & Low & High & Low & \\
\midrule
Sonnet 4.5 & 0.91 & 0.88 & 0.88 & 0.91 & 0.94 & 0.97 & 0.88 & 4 \\
Opus 4.6 & 0.66 & 0.62 & \textbf{0.78} & 0.66 & 0.78 & 0.72 & 0.66 & 4 \\
GPT-5.2 & 0.78 & 0.59 & 0.72 & 0.78 & 0.81 & 0.75 & 0.69 & 4 \\
GPT-4.1 & 0.91 & 0.78 & 0.75 & 0.75 & 0.75 & 0.75 & 0.75 & 4 \\
\midrule
\textit{Human (split-half)} & 0.44 & 0.36 & 0.52 & 0.26 & 0.34 & 0.49 & 0.32 & 4 \\
\bottomrule
\end{tabular}
\end{table}
...
& Low & High & Male & Female & Low & High & Low & \\
\midrule
Sonnet 4.5 & 0.91 & 0.93 & 0.92 & 0.94 & \textbf{0.93} & 0.92 & 0.93 & 4 \\
Opus 4.6 & 0.76 & 0.82 & 0.81 & 0.78 & 0.80 & 0.78 & 0.79 & 4 \\
GPT-5.2 & 0.87 & 0.82 & 0.85 & 0.84 & 0.85 & 0.84 & 0.84 & 4 \\
GPT-4.1 & 0.93 & 0.89 & 0.92 & 0.91 & 0.91 & 0.93 & 0.93 & 4 \\
\midrule
\textit{Human (split-half)} & 0.82 & 0.75 & 0.85 & 0.66 & 0.80 & 0.76 & 0.79 & 4 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Sonnet 4.5 & \textbf{+0.875} & +0.030 & \textbf{+0.440}  & $-$0.020 \\
Opus 4.6   & +0.125           & +0.040            & $-$0.130         & \textbf{$-$0.060} \\
GPT-5.2    & $-$0.125         & \textbf{+0.190}   & $-$0.060         & +0.050 \\
GPT-4.1    & +0.250           & +0.130            & $-$0.080         & +0.040 \\
\bottomrule
\end{tabular}
\end{table}
...
& \textbf{(Perception)} & \textbf{(Information)} & \textbf{(Perception)} & \textbf{(Information)} \\
\midrule
Sonnet 4.5 & +0.125           & $-$0.030   & $-$0.050          & $-$0.020 \\
Opus 4.6   & 0.000            & \textbf{+0.120}             & $-$0.020          & \textbf{+0.030} \\
GPT-5.2    & +0.375           & $-$0.060             & \textbf{$-$0.060} & +0.010 \\
GPT-4.1    & \textbf{+0.625}  & 0.000             & $-$0.030          & +0.010 \\
\bottomrule
\end{tabular}
\end{table}
...
disparity (gap$=$+0.440). These results indicate that
...
however, after the multi-select correction it now exhibits
...
For information-based questions, the previously reported
...
Across all models, EAD sex gaps were uniformly small
...
\midrule
Information
& DS1: Short+Difficult & 0.25 & 0.38 & $-$0.13 & 0.44 & 0.52 & $-$0.07 \\
& DS2: Long+Simple     & 1.50 & 1.25 & \textbf{+0.25}  & 1.21 & 1.16 & \textbf{+0.05} \\
& DS3: Long+Difficult  & 1.13 & 0.88 & +0.25         & 0.99 & 1.02 & $-$0.03 \\
& DS4: Short+Simple    & 0.75 & 1.00 & $-$0.25         & 1.00 & 1.01 & $-$0.01 \\
\cmidrule(lr){2-8}
& Overall              & 0.91 & 0.88 & +0.03           & 0.91 & 0.93 & $-$0.02 \\
\bottomrule
\end{tabular}
\end{table}
...
Under the corrected mapping the information-question education
...
One pattern survives the correction; the other does not.
...
\item \textbf{Document length does \emph{not} amplify the
